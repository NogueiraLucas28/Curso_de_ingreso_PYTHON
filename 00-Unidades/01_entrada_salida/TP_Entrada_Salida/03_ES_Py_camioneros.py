...
class App(customtkinter.CTk):
    ...
    def btn_cantidad_camiones_on_click(self):
        ...
        cantidad_camiones = toneladas / 3.5
        cantidad_camiones = math.ceil(cantidad_camiones)

        mensaje = "Cantidad de camiones necesarios: " + str(cantidad_camiones)
    ...
    def btn_tiempo_llegada_on_click(self):
        ...
        tiempo_llegada = distancia / 90 

        mensaje = f"Cada camion tardara {tiempo_llegada} hora/s"
        alert("", mensaje)
