...
class App(customtkinter.CTk):
    ...
    def btn_validar_on_click(self):
        for postulantes in range (10):
            ...
            while puesto != "Jr" and puesto != "Ssr" and puesto != "Ssr":
                puesto = prompt("UTN", "Reingrese tecnologia")
